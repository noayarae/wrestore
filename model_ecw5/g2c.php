...
<!-- LOCALHOST-LINK      http://localhost/wrestoreBCK1/model_ecw5/g2c.php-->
            ...
            <div id="line2-col2" style="float: right;">
                <div class="topnav" style="display: -webkit-inline-box;">
                    ...
                    <div style="color: #FFFFFF">USER :
                        ...
                        <span id="session_pilot_test" style="color: #ffffff; padding: 0px 5px">session 2</span>
                    </div>
...
the costs and benefits over the watershed landscape">STEP 1:
                    ...
                    <div>
                        <h4 class="step_title_text fontStepTitle">Learn about <font
                                    color="#7d110c"><strong>Suggested Plan P<span
...
<!--                                <li style="display: none; width: 40px;"><a id="step1_P_tab" class="trackable" title="Profit (Revenue-Cost)-->
                                <li><a id="step1_P_tab" class="trackable" title="Profit (Revenue-Cost)
in US Dollars" style="margin: 0px 0px 0px 4px;" href="#tabs-RV">P</a></li>
                            ...
                            <div class="tab_container2">
                                ...
                                <div id="info_heatmap" class='tab_content2' style="height: 98%; overflow: auto;">
                                    ...
                                    <p>Click on the tab to view how the performance (i.e., benefits and costs) of this
...
(on previous or following pages of this session)">
                    ...
                    <div>
                        <h4 class="step_title_text fontStepTitle">Evaluate <font color="#7d110c"><strong>Suggested
                                    Plan P<span class="oneMap"></span></strong></font> </h4>
                    </div>
                </div>
...
<!--                        <div id="start_barplot" style="height: 406px; overflow: auto; border: 1px solid red">-->
                            <h4 style="font-size: 20px">Instructions </h4>
                            <p>Click on the tab to view bar plots that assess the performance (i.e., benefits and costs) of
                                this suggested plan in comparison to others.</p>
                            <p>Also, note the following about the bar plots:</p>
                            <ol>
                                <li>The yellos colored bar corresponds to the suggested plan you see on this page.</li>
                                ...
                                <div class="map1" style="height:25px; display: inline-flex; margin: 5px;">
                                    ...
                                    <div class="innerMapLines" style="min-width: 120px;">
                                        <div class="rating">
                                            ...
                                            <input id='performance_rate_0' class="trackable check_last_SP" name="rating1"
                                                   type="radio" value="0" checked /><span id="hide"></span>
                                            <input id='performance_rate_1' class="trackable check_last_SP" name="rating1"
                                                   type="radio" value="1" /><span></span>
                                            <input id='performance_rate_2' class="trackable check_last_SP" name="rating1"
                                                   type="radio" value="2" /><span></span>
                                            <input id='performance_rate_3' class="trackable check_last_SP" name="rating1"
                                                   type="radio" value="3" /><span></span>
                                            <input id='performance_rate_4' class="trackable check_last_SP" name="rating1"
                                                   type="radio" value="4" /><span></span>
                                            <input id='performance_rate_5' class="trackable check_last_SP" name="rating1"
                                                   type="radio" value="5" /><span></span>
                                            <input id='performance_rate_6' class="trackable check_last_SP" name="rating1"
                                                   type="radio" value="6" /><span></span>
                                            <input id='performance_rate_7' class="trackable check_last_SP" name="rating1"
...
<!-- ===================================  VOLADIZOS  =================================== -->
    <!--  VOLADIZOS  -->
    <!--  (1) Start: Voladizo 1: SLIDE -->

    <!--
    <div id="slidecontainer" class="slidecontainer">
        <input id="myRange" class="slider" type="range" min="1" max="3" step="1" value="2"
               oninput="showVal(this.value)" onchange="actionVal(this.value)">
        ...
        <p>Slide value: <span id="slide_value"></span></p>
        <div>Display: <span id="slide_display"></span></div>
    -->

    <script>
        function showVal(newVal){
            document.getElementById("slide_value").innerHTML = newVal;
        }
        function actionVal(newVal){
            // document.getElementById("action_slide").innerHTML=newVal;

            var x = parseInt(newVal);
            // alert(typeof newVal);
            switch (x) {
                case 1:
                    document.getElementById("slide_display").innerHTML="Map "+newVal;
                    // text = "Off";
                    break;
                case 2:
                    document.getElementById("slide_display").innerHTML="Map "+newVal;
                ...
                case 3:
                    ...
                    break;
                default:
                    document.getElementById("slide_display").innerHTML="Map "+"default";
            }
        }
    </script>
    <!--  (1) End: Voladizo 1: SLIDE -->
...
<!--                     (below) to continue with session 2.</p>-->
...
//    var heatnita = new Array();//E: To save mean values of NR of each subbasin (108 in total) as Array
    ...
    var PFR_minVals_array = new Array();//E: Save PFR MIN-values of each subbasin (108 total) asArray for building the HeatMap
    var PFR_maxVals_array = new Array();//E: Save PFR MAX-values of each subbasin (108 total) asArray for building the HeatMap
...
//        heatiter = 1;
            ...
            var PFR_min_value_js = new Array();
            var PFR_max_value_js = new Array();
...
//                if (i<1) console.log("L.1497: \n"+ typeof aux2+ " ; "+ aux2.length+ " ; "+ JSON.stringify(aux2));
                ...
                PFR_min_value_js.push({name: iter_subbasins, val: -aux2[1][1]});//E:
                PFR_max_value_js.push({name: iter_subbasins, val: -aux2[1][2]});//E:
            ...
            var pfr_mmm = [PFR_mean_value_js, PFR_min_value_js, PFR_max_value_js];
            // alert (typeof pfr_mmm);
            var x;

            for (x of pfr_mmm) {//E: This function sorts the given array
                x.sort(function (a, b) {
                    if ((typeof b.val === 'undefined' && typeof a.val !== 'undefined') || a.val < b.val) {
                        return -1;
                    }
            ...
            PFR_minVals_array.push({name:iter_altern, val:PFR_min_value_js});//E:
            PFR_maxVals_array.push({name:iter_altern, val:PFR_max_value_js});//E:
...
//            google.maps.event.addDomListener(window, 'load', initialize);
        ...
        function setUpRadio(){
            ...
            // alert("L.1848: "+answersArray[oneMap].RATING1);
//            var ratingAnswer=answersArray[oneMap].RATING;
           ...
           // alert("L.1851 alert 1: oneMap = "+oneMap+"  r1= "+ ratingAnswer);
...
//            var ratingAnswer2=answersArray[oneMap].RATING1;//E: @@@
           ...
           // alert("L.1883 alert 1: oneMap = "+oneMap+"  r2= "+ ratingAnswer2);
            ...
            // alert("L.1945: " + answersArray[oneMap].RATING1);
...
//        $("#rating2").val(answersArray[oneMap].RATING1);//E: @@@
    ...
    //                bmpArray=array[page-1].CHOSENBMP;
    //                alert("new 'bmpArray' to display: ["+ (page-1) +"]: " + bmpArray);//E: it provides the CHOSENBMP from DDBB
    //                oneMap=oneMap+2;
    ...
    //                alert("L.1689 OneMap-after: "+ oneMap);
                    console.log("L.2181 Alternative: "+ oneMap+1);
    //                alert("new 'page': " + page);//E: 'page' was increased into 1 above
    //                 alert("L.2183 move-Next: next 'bmpArray' index: " + oneMap);//E:
...
//         report('BEGINNING Sug.Plan and ID2 = ', (oneMap+1)+" and "+ array_fullvalues[oneMap].ID2.toString());
