...
function initialize() {
    ...
    basemap_1 = new google.maps.Map(document.getElementById('map_canvas1'), {
        center: new google.maps.LatLng(39.9978, -86.34),//E: center for "ecw" scale 11. For CCE Lab
    ...
    //E: this was included for Exp 3. Delete this for not selecting "Sub-basin 9"
    select_sb(); //E: fn to draw rivers across the watershed
                ...
                if (sb_wet_match) {
                    ...
                    switch (true) {
                        case (wetlandsize == 0):
                            // wetlandsIcon = "";
                            // alert("here");
                            wetlandsIcon = svg_to_img('svg0');
                            break;

                        // case (wetlandsize < 2):
                        case ((wetlandsize >= 0) && (wetlandsize < 0.5)): // case ((wetlandsize >= 0) && (wetlandsize < 2)):
                            wetlandsIcon = svg_to_img('svg1');
                            break;

                        case ((wetlandsize >= 0.5) && (wetlandsize < 1)): // case ((wetlandsize >= 2) && (wetlandsize < 6)):
                            wetlandsIcon = svg_to_img('svg2');
                            break;

                        case ((wetlandsize >= 1) && (wetlandsize < 3)): // case ((wetlandsize >= 6) && (wetlandsize < 11)):
                            wetlandsIcon = svg_to_img('svg3');
                            break;

                        case ((wetlandsize >= 3) && (wetlandsize < 6)): // case ((wetlandsize >= 11) && (wetlandsize < 15)):
                            wetlandsIcon = svg_to_img('svg4');
                            break;

                        case ((wetlandsize >= 6) && (wetlandsize < 12)): // case ((wetlandsize >= 15) && (wetlandsize < 29)):
                            wetlandsIcon = svg_to_img('svg5');
                            break;

                        case ((wetlandsize >= 12) && (wetlandsize < 20)): // case ((wetlandsize >= 29) && (wetlandsize < 40)):
                            wetlandsIcon = svg_to_img('svg6');
                            break;

                        case ((wetlandsize >= 20)): // case ((wetlandsize >= 40)):
...
function select_sb(){
    ...
    ///////////////////// EXP 3 //////////////////
    // For experiment #3, we set  selected_sb="S9"
    selected_sb = "S9";
    ///////////////////// end: EXP 3 //////////////////
    //E: This was commented for Exp 3
    // var selected_sb = subDrop[subDrop.selectedIndex].value;
    // alert("L.1920 selected_sb: "+ selected_sb);
