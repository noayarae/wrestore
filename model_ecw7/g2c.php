...
<!--    <script type="text/javascript" src="js/jquery.collapsible.js"></script>-->
    ...
    <script type="text/javascript" src="js/barplot_left.js"></script>
    <!-- These two JS Scripts are set for mouse Tracking -->
...
<!--    DATA    -->
    ...
    <script type="text/javascript">
        ...
        google.charts.setOnLoadCallback(subBasin_barplot_left);
    </script>
...
<!--                        <span id="session_pilot_test" style="color: #ffffff; padding: 0px 5px">session 1</span>-->
                        <span id="session_pilot_test" style="color: #ffffff; padding: 0px 5px">session e2</span>
                    </div>
            ...
            <div class="mapHolder1 map1" style="height: 100%">
                <div class="step_line" style="height: 26px;">
                    <div id="step1" class="step_box"
                     title="Learn about recommended conservation decisions in this
                    ...
                    <!--  This was set in 'maptype_plug.js'  -->
                        ...
                        <input id="fullscreen" class="trackable" title="Click here to display a fullscreen map" type="button"
                           ...
                           left: 120px; z-index: 200; width: 90px; height: 26px;/*background-color: #fcd4b5;*/ cursor: pointer" />
                    </div>
                    <!-- <div>
                      <h3>here</h3>
                    </div> -->
                    ...
                    <script>
                    // E: For reference see: https://www.tutorialspoint.com/jqueryui/jqueryui_tabs.htm
                        $( function() {
                            $("#tabs_hm").tabs();
                        } );
                    </script>
                    ...
                    <div class ="panel_1 collapsed" name='step1_alter'>
                        <div>
                            <h6 style="font-family: 'Oswald', Arial, Helvetica, sans-serif; font-size: 17px; padding-left: 8px; margin-bottom: 0;">
                                Impact of SP<span class="oneMap"></span> on your Sub-basin #9
                            </h6>
                        </div>
                        ...
                        <div id="tabs_hm" style="font-size: 12px; height: 100%;">
                          <ul class="tabs_heatmap">
                                <li><a id="step1_start" class="trackable"
                                  href="#info_heatmap">Info*</a>
                                </li>
                                <li>
                                  <a id="step1_PFR_tab" class="trackable" title="Peak Flow Reduction in cubic meters per second (cms)"
                                  href="#tabs-PF">PFR</a>
                                </li>
                                <li style="display: none"><a id="step1_SR_tab" class="trackable" title="Sediment Reduction in tons"
                                  href="#tabs-SR">SR</a></li>
                                <!-- <li><a id="step1_SR_tab" class="trackable" title="Sediment Reduction in tons" href="#tabs-SR">SR</a></li>-->
                                <li style="display: none"><a id="step1_NR_tab" class="trackable" title="Nitrate Reduction in kilograms (kg)"
                                  href="#tabs-NR">NR</a></li>
                                <!-- <li><a id="step1_NR_tab" class="trackable" title="Nitrate Reduction in kilograms (kg)" href="#tabs-NR">NR</a></li>-->
                                <li style="display: none; width: 40px;">
                                  <a id="step1_P_tab" class="trackable" title="Profit (Revenue-Cost) in US Dollars" style="margin: 0px 0px 0px 4px;"
                                  href="#tabs-RV">P</a>
                                </li>
                          </ul>
                            ...
                            <!-- <div class="tab_container2"> -->
                                ...
                                <div id="info_heatmap" class='tab_content2' style="height: 98%; overflow: auto;">
                                    ...
                                    <p>Click on the PFR tab to view bar plots that assess the performance (i.e., benefits) of
                                        this suggested plan in comparison to others for your <b>Sub-basin #9</b> (local benefit).</p>
                                    ...
                                    <ol>
                                        ...
                                        <li>The length of the bar corresponds to an average value of the benefit.</li>
                                ...
                                <!--    ------------ (2a) tabs-PFR heatmap ------------   -->
                                <!-- inserting bar-plot INSTEAD heatmap -->
                                <div id="tabs-PF" style="height: 85%; overflow-x: hidden; overflow-y: overlay;">
                                    <div id="chart_bp1"></div>
                                    <div style="position: absolute; width: 250px; top: 415px;/*top: 385px;*/ left:5px; padding: 0px 10px;
                                ...
                                <!-- This div is for heatmap. This was switch for Experiment 3 -->
                                <!-- <div id="tabs-PF" class="map1" style="display: none">
                    ...
                    <!--   +++++++++++   finish insert HeatMaps in Step 1 (L.267 - L.396)+++++++++++ -->

                    <!-- +++++++  Start: Insert title for the main map   +++++++  -->
                    <!-- This tags are for the Main map title -->
                    <div style="position: relative; top: 30px; left: -200px; z-index: 200; width: 370px; height: 45px;
                    background-color: #ffffff; border: 1px solid #d85a1a; border-radius: 5px; text-align: center;">
                        <h6>Wetlands proposed by SP<span class="oneMap"></span> in all Sub-basins with your sub-basin highlighted</h6>
                    </div>
                    <!-- +++++++  End: Insert title for the main map   +++++++  -->

                </div>

                <!-- ++++++++++++++  Start: Draw the main map (base-map) +++++++++++++++ -->
                <div id="mapHolderOne">
                  <!-- This div sets the main map DOM. It is called from L.68 'mapping_new_g2c.js' -->
                    <div id="map_canvas1" name="map_canvas1"></div>
                </div>

                <!-- ++++++++++++++  End: Draw the main map (base-map) +++++++++++++++ -->
...
(on previous or following pages of this session)">
                ...
                <div class="graph">
                    <div>
                        <h6 style="font-family: 'Oswald', Arial, Helvetica, sans-serif; font-size: 17px; padding-left: 8px; margin-bottom: 0;">
                            Impact of SP<span class="oneMap"></span> on entire watershed
                        </h6>
                    </div>
...
<!--                            <option id="watershed" value="Watershed" selected="selected">Full Watershed</option>-->
                    ...
                    450px;">
                        <ul class="tabs_barplot">
                            ...
                            40px*/">
                                    Info</a></li>
                            <li><a id="step2-PFR" class="trackable"  title="Peak Flow Reduction in cubic meters per second (cms)"
                              href="#PFR_barplot" >PFR</a></li>
...
in US Dollars" style="margin: 0px 0px 0px
                        ...
                        <!-- <div id="start_barplot" style="height: 406px; overflow: auto; border: 1px solid red"> -->
                            <div id="start_barplot" style="height: 99%; overflow: auto;">
                                <h4 style="font-size: 20px">Instructions </h4>
                                <p>Click on the PFR tab to view bar plots that assess the performance (i.e., benefits and costs) of
                                this suggested plan in comparison to others for the <b>entire watershed</b> (global benefit).</p>
                                <p>Also, note the following about the bar plots:</p>
...
<!--    <div>-->
        ...
        <!-- <div id="div1">wetlands' Ranges: r = [<0.2],[0.2-2], [2-6], [6-11], [11-15], [15-29], [29-40], [>40]</div> -->

        <!-- "svg0" is set r=0 to make an empty circle for Wetland = 0 -->
        <svg id="svg0" width="2" height="2">
        <!--            <circle cx="3.5" cy="3.5" r="3.5" fill="#336699" />-->
        <!--            <circle cx="3.0" cy="3.0" r="3.0" stroke="#001141" stroke-width="1" fill="#001141" />-->
            <!-- <circle cx="1.5" cy="1.5" r="1.5" stroke="#003300" stroke-width="1" fill="#006600" /> -->
            <circle cx="1" cy="1" r="0" stroke="#003300" stroke-width="0" />
