...
<!--    <script type="text/javascript" src="js/jquery.collapsible.js"></script>-->
    <script type="text/javascript" src="js/bargraphcpy_g3.js"></script>
...
<script type="text/javascript" src="js/mapping_new_g3.js"></script>
<script type="text/javascript" src="js/heatmapnew1_g3.js"></script>
...
//                alert ("L.1323 BMP-array: index= "+ index1+ "  value = "+value1);
            ...
            console.log("L.1610 forMapArray: \n"+ JSON.stringify(forMapArray));
