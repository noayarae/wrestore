...
function initialize() {
    ...
    basemap_1 = new google.maps.Map(document.getElementById('map_canvas1'), {
        center: new google.maps.LatLng(39.9778, -86.44),//E: center for "ecw" scale 10.5
    ...
    var cc_checkbox = new checkBox_CoverCrop(cc_checkOptions);//cc: "Cover Crop". This function is located at "checkbox_plug.js"
    ...
    var sc_checkbox = new checkBox_StripCropping(sc_checkOptions); //sc: "Strip Cropping". This function is located at "checkbox_plug.js"
    ...
    var fs_checkbox = new checkBox_FilterStrip(fs_checkOptions); //fs: "filter strip". This function is located at "checkbox_plug.js"
    ...
    var gw_checkbox = new checkBox_Grasswaterways(gw_checkOptions); //gw: "Grass waterways". This function is located at "checkbox_plug.js"
    ...
    var nt_checkbox = new checkBox_NoTillage(nt_checkOptions); //nt: "NoTillage". This function is located at "checkbox_plug.js"
    ...
    var wt_checkbox = new checkBox_Wetlands(wt_checkOptions); //wt: "Wetlands". This function is located at "checkbox_plug.js"
    ...
    var color_wetland = {//E: For 20 intervals
