...
<!--    <script src="data/takefeedback2b.js"></script>-->
        <script src="data/takefeedback3b.js"></script>
...
<!--                        <div id="start_barplot" style="height: 406px; overflow: auto; border: 1px solid red">-->
                        ...
                        <div id="PFR_barplot" style="height: 100%; overflow-x: hidden; overflow-y: overlay;">
                            ...
                            <div style="position: absolute; width: 250px; top: 385px; left:35px; padding: 0px 10px;
    ...
    <div id="instruction_box1">
        ...
        <div id="message_box">
            <div id="ints_welcome-msg">
                ...
                <p>In WRESTORE, an option is also called a
                    <b>conservation plan</b>. Every suggested conservation plan consists of multiple conservation
                    decisions distributed over the landscape. Each conservation decision describes the type of
                    recommended conservation practice, location where the practice is implemented, and other
                    attributes such as size, etc.</p>
                <div style="line-height:30%;"><br></div>
                <p>You are advise to first learn about decisions recommended by a suggested conservation plan (i.e.
...
//        alert("Begining. Alternative 1");
        ...
        Shadowbox.open({
            ...
            '<p>In WRESTORE, an option is also called a <b>conservation plan</b>. Every suggested conservation plan ' +
            'consists of multiple conservation decisions distributed over the landscape. Each conservation decision ' +
            'describes the type of recommended conservation practice, location where the practice is implemented, and' +
            ' other attributes such as size, etc.</p>' + '<div style="line-height:30%;"><br></div>' +
            '<p>You are advise to first learn about decisions recommended by an suggested conservation plan (i.e. ' +
            '<b>Step 1</b>), then assess its performance in comparison to other plans suggested in the user session ' +
            '(i.e. <b>Step 2</b>), and then finally evaluate the suggested based on its overall performance, ' +
            'feasibility, and your own personal preferences (i.e. <b>Step 3</b>).</p>'+
            '<div style="line-height:30%;"><br></div>' +
            '<p>Your feedback will help WRESTORE create new conservation plans that best meet your ' +
